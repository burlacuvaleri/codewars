...
public class TribonacciSequence {
    ...
    public static void main(String[] args) {
        ...
        //double[] r = tribonacci(new double[]{1,1,1},10);
        //double[] r = tribonacci(new double[]{0,0,1},10);
        //double[] r = tribonacci(new double[]{0,1,1},10);
        double[] r = tribonacci(new double[]{13.0, 12.0, 16.0},49);
